...
class CommunityGames extends StatefulWidget {
  const CommunityGames({super.key});
  static const routeName = '/community_games';

  @override
  State<CommunityGames> createState() => _CommunityGamesState();
}

class _CommunityGamesState extends State<CommunityGames> {
  bool isLogin = false;
